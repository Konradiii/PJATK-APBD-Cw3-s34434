...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie01_StudenciZWarszawy()
    {
        return DaneUczelni.Studenci
            ...
            .Select(e => $"{e.Miasto} {e.Imie} {e.Nazwisko} {e.NumerIndeksu}");
    }
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        return new[]
        {
            DaneUczelni.Przedmioty
                ...
                .FirstOrDefault() ?? "Brak przedmiotów z kategorii Analytics"
        };
    ...
    {
        return DaneUczelni.Studenci
            .Where(e => e.Miasto != null)
            .OrderBy(e => e.Miasto)
            .Select(e => $"{e.Miasto},{e.Imie},{e.Nazwisko}");
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Where(z => z.z.OcenaKoncowa is not null)
            .GroupBy(p => p.p.Nazwa)
            .Select(p => $"{p.Key},{p.Average(x=> x.z.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            ...
            .Select(x => $"{x.pr.Imie} {x.pr.Nazwisko}, {x.p.Count()}");    
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            ...
            .Where(e => e.z.OcenaKoncowa is not null)
            .GroupBy(e => new { e.s.Imie, e.s.Nazwisko })
            .Select(g => $"{g.Key.Imie},{g.Key.Nazwisko},{g.Max(e => e.z.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            .Join(
                ...
                z => z.PrzedmiotId,
                (p,z)=> new{p,z})
            .Where(x=>(x.p.DataStartu.Month == 4) && ((x.p.DataStartu.Year)==2026))
            .GroupBy(e=>e.p.Nazwa)
            .Where(x=> x.All(g=> g.z.OcenaKoncowa == null))
            .Select(p=>$"{p.Key}");
    }
